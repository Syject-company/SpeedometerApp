...
public class LandingpageDialog extends DialogFragment implements PurchasesUpdatedListener {

    private OnDialogClose mOnButtonClickListener;
    ...
    public static LandingpageDialog newInstance(String title) {
        LandingpageDialog frag = new LandingpageDialog();
        ...
        if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK
            ...
            for (Purchase purchase : list) {
                if (purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
                    ...
                    mOnButtonClickListener.closeDialog(true);
            ...
            Snackbar.make(rootView, R.string.user_canceled, Snackbar.LENGTH_LONG).setAction(R.string.start_trial, new View.OnClickListener() {
                @Override
    ...
    public interface OnDialogClose{
        void closeDialog(boolean boughtPremium);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            mOnButtonClickListener = (OnDialogClose) context;
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mOnButtonClickListener.closeDialog(false);
            }
        });
