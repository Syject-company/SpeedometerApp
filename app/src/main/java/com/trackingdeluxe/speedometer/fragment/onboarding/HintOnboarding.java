...
public class HintOnboarding extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = (ViewGroup) inflater.inflate(
                R.layout.onboarding3_hint, container, false);

        Button next = rootView.findViewById(R.id.btn_ob_3);
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mOnButtonClickListener.pageSwitch(3);
            }
        });
